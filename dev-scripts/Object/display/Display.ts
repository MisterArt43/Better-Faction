...
export class Display {
	...
	static add_display(display: Display | undefined) {
		...
		// Server.runCommand("scoreboard players set \"$db_display(" + textToHex(JSON.stringify(display)) + ")\" db_display 1");
	}
	...
	static remove_display(display: Display | undefined) {
		...
		// Server.runCommand("scoreboard players reset \"$db_display(" + textToHex(JSON.stringify(display)) + ")\" db_display");
	...
	remove_to_update_display() {
		...
		// Server.runCommand("scoreboard players reset \"$db_display(" + textToHex(JSON.stringify(this)) + ")\" db_display");
	}
	...
	add_to_update_display() {
		...
		// Server.runCommand("scoreboard players set \"$db_display(" + textToHex(JSON.stringify(this)) + ")\" db_display 1");
	}
}
