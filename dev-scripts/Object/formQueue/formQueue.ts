import { ActionFormData, ActionFormResponse, FormCancelationReason, MessageFormData, MessageFormResponse, ModalFormData, ModalFormDataDropdownOptions, ModalFormDataSliderOptions, ModalFormDataTextFieldOptions, ModalFormDataToggleOptions, ModalFormResponse } from "@minecraft/server-ui";
...
export class BFModalFormData extends ModalFormData {
    ...
    header(titleText: RawMessage | string): this {
        super.header(titleText);
        return this;
    }
    ...
    textField(label: RawMessage | string, placeholderText: RawMessage | string, textFieldOptions?: ModalFormDataTextFieldOptions | string): this {
        if (typeof textFieldOptions === "string") textFieldOptions = { defaultValue: textFieldOptions };
        super.textField(label, placeholderText, textFieldOptions);
        return this;
    }
    dropdown(label: RawMessage | string, options: (RawMessage | string)[], dropdownOptions?: ModalFormDataDropdownOptions | number): this {
        if (typeof dropdownOptions === "number") dropdownOptions = { defaultValueIndex: dropdownOptions };
        super.dropdown(label, options, dropdownOptions);
        return this;
    }
    slider(label: RawMessage | string, minimumValue: number, maximumValue: number, sliderOptions?: ModalFormDataSliderOptions | number, defaultValue?: number): this {
        if (typeof sliderOptions === "number") sliderOptions = { valueStep: sliderOptions };
        if (defaultValue !== undefined) sliderOptions = { ...sliderOptions, defaultValue };
        super.slider(label, minimumValue, maximumValue, sliderOptions);
        return this;
    }
    toggle(label: RawMessage | string, toggleOptions?: ModalFormDataToggleOptions | boolean): this {
        if (typeof toggleOptions === "boolean") toggleOptions = { defaultValue: toggleOptions };
        super.toggle(label, toggleOptions);
        return this;
    }
