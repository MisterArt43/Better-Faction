...
export class CMDLinker {
    ...
    static async initDB_link() {
        ...
        remove_to_update_link() {
            ...
            // Server.runCommand("scoreboard links reset \"$db_link(" + textToHex(JSON.stringify(this)) + ")\" db_link");
        }
        ...
        add_to_update_link() {
            ...
            // Server.runCommand("scoreboard links set \"$db_link(" + textToHex(JSON.stringify(this)) + ")\" db_link 1");
        }
        ...
        static add_link(link: CMDLinker | undefined) {
            ...
            // Server.runCommand("scoreboard links set \"$db_link(" + textToHex(JSON.stringify(link)) + ")\" db_link 1");
        }
        ...
        static remove_link(link: CMDLinker | undefined) {
            ...
            // Server.runCommand("scoreboard links reset \"$db_link(" + textToHex(JSON.stringify(link)) + ")\" db_link");
