...
export class Ply {
	...
	remove_to_update_player() {
		...
		// Server.runCommand("scoreboard players reset \"$db_player(" + textToHex(JSON.stringify(this)) + ")\" db_player");
	}
	...
	add_to_update_player() {
		...
		// Server.runCommand("scoreboard players set \"$db_player(" + textToHex(JSON.stringify(this)) + ")\" db_player 1");
	}
	...
	static add_player(player: Ply | undefined) {
		...
		// Server.runCommand("scoreboard players set \"$db_player(" + textToHex(JSON.stringify(player)) + ")\" db_player 1");
	}
	...
	static remove_player(player: Ply | undefined) {
		...
		// Server.runCommand("scoreboard players reset \"$db_player(" + textToHex(JSON.stringify(player)) + ")\" db_player");
